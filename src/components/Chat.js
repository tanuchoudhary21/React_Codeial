    ...
    return (
      <div className="chat-container">
        ...
        <div className="chat-messages">
          {/* <p className = 'chat-bubble self-chat' >Hey how are you??</p>
          <p className = 'chat-bubble other-chat' >I am fine you say??</p>
          <p className = 'chat-bubble self-chat' >It was fun taking talking to you !!</p> */}
